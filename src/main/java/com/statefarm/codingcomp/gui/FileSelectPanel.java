...
public class FileSelectPanel extends JPanel implements ItemListener {
	...
	private String policyFile = "src/main/resources/policies.csv";
	...
	public FileSelectPanel() { 
		...
		this.add(inner);
		JLabel title = new JLabel("Policy Data Visualization");
